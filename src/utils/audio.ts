/**
 * Web Audio API Sound Synthesizer for Minecraft & Angry Birds SFX
...
/**
 * Angry Birds TNT Explosion Sound ("BOOM!")
 */
...
/**
 * Angry Birds Slingshot Stretch/Swoosh
 */
...
/**
 * Minecraft Crafting Table Click & Item Craft
 */
...
/**
 * Redstone Signal Activation Hum/Spark
 */
export const playRedstoneSound = () => {
  if (soundMuted) return;
  const ctx = getAudioContext();
  if (!ctx) return;
...
/**
 * Pressure Plate Step Click (Minecraft Arrival)
 */
...
/**
 * EXP Level Up Chime (Minecraft Orbs)
 */
